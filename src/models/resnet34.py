...
class ResNet34(nn.Module):
    ...
    def __init__(self, *, number_of_classes : int, layers_to_freeze : int = 5):

        super().__init__()

        self.resnet34 = models.resnet34(weights='IMAGENET1K_V2')
        ...
        self.resnet34.fc = nn.Linear(in_features=self.resnet34.fc.in_features,out_features=number_of_classes)
